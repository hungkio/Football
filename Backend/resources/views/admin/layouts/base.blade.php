...
<script>
    if($('.noidung').length>0){
        var editor_config = {
            ...
            toolbar: "styleselect | bold italic underline | bullet numbered | alignleft aligncenter alignright alignjustify | outdent indent | link table code image media fullscreen preview",
            relative_urls: false,
