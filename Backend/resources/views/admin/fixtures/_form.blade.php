                    ...
                    <x-card>
                        <fieldset>
                            ...
                            <div class="collapse show" id="general">
                                <x-text-field name="api_id" :placeholder="__('Mã trận')" :label="__('Mã trận')" :value="isset($fixture) ? $fixture->api_id : ''" required > </x-text-field>
                                ...
                                <x-text-field name="round_1" :placeholder="__('Hiệp 1')" :label="__('Hiệp 1')" :value="isset($fixture) ? Carbon::createFromTimeStamp(json_decode($fixture->periods)->first)->format('Y-m-d H:i:s') : ''" > </x-text-field>
                                <x-text-field name="round_2" :placeholder="__('Hiệp 2')" :label="__('Hiệp 2')" :value="isset($fixture) ? Carbon::createFromTimeStamp(json_decode($fixture->periods)->second)->format('Y-m-d H:i:s') : ''" > </x-text-field>
                                <x-text-field name="venue_id" :placeholder="__('ID sân')" :label="__('ID sân')" :value="isset($fixture) ? json_decode($fixture->venue)->id  : ''" > </x-text-field>
                                <x-text-field name="league_id" :placeholder="__('ID giải')" :label="__('ID giải')" :value="isset($fixture) ? json_decode($fixture->league)->id  : ''" > </x-text-field>
                                <x-text-field name="team_home" :placeholder="__('Đội nhà')" :label="__('Đội nhà')" :value="isset($fixture) ? json_decode($fixture->teams)->home->id : ''" > </x-text-field>
                                <x-text-field name="team_away" :placeholder="__('Đội Khách')" :label="__('Đội Khách')" :value="isset($fixture) ? json_decode($fixture->teams)->away->id : ''" > </x-text-field>
