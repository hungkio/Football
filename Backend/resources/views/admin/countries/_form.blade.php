                            ...
                            <div class="collapse show" id="general">
                                ...
                                <div class="tab-content">
                                    <div id="en" class="tab-pane fade in active show">
                                        <x-textarea-field name="content" :label="__('Nội dung')" :value="isset($country) ? $country->content : ''" :placeholder="__('Nội dung')" > </x-textarea-field>
                                    ...
                                    <div id="vi" class="tab-pane">
                                        <x-textarea-field name="content_vi" :label="__('Nội dung')" :value="isset($country) ? $country->content_vi : ''" :placeholder="__('Nội dung')" > </x-textarea-field>
