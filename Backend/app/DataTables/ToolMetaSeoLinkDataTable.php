...
class ToolMetaSeoLinkDataTable extends BaseDatable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', 'admin.tools-meta-seo-link._tableAction')
            ->addIndexColumn();
     ...
     */
    public function query(ToolMetaSeoLink $model): Builder
    {
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('meta_canonical')->title(__('meta_canonical'))->searchable(),
