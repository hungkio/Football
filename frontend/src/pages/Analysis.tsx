...
const Analysis = () => {
  return (
    <Default>
      ...
      <div>
        <p className="text-xs font-bold px-2.5 py-1.5 bg-[#ddd]">
          <span className="uppercase">Nhận định bóng đá Châu Âu</span>
          <span className="px-2">&gt;</span>
          <span className="uppercase">U19 EURO</span>
        </p>
        <div>
          <div className="flex items-center gap-2 text-xs py-1.5 border-b border-[#eee] last-of-type:border-none">
            <span className="rounded-3xl text-red min-w-14 px-2 py-1 border border-[#eee] inline-block text-center">Live</span>
            <Link to={''}>Nhận định U19 Tây Ban Nha vs U19 Pháp, 1h00 ngày 23/7</Link>
